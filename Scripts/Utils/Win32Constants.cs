...
namespace Utils
{
    public static class Win32Constants
    {
        ...
        public const int WINDOW_MAX = 0x0003;
        public const int WINDOW_MIN = 0x0002;
        public const int WINDOW_NORMAL = 0x0001;

        // 窗口操作
        public const int POS_STATUS_On = -1; // 窗体置顶
        public const int POS_STATUS_OFF = -2;  // 窗体不置顶
        public const int WINDOW_NOMOVE = 0x0002; //不调整窗体位置
        public const int WINDOW_NOSIZE = 0x0001; //不调整窗体大小
