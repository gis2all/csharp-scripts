...
namespace Utils
{
    public class KeyBoardConstant
    {
        ...
        public const byte vKeyLeftWin = 91;     // 左Win键
        public const byte vKeyRightWin = 92;    // 右Win键
        ...
        public const byte vKey_Press = 0; //按下按键
        public const byte vKey_Release = 0x02; //松开按键
